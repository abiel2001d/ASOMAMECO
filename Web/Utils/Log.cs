        ...
        private static string GetCustomErrorByNumber(SqlException pSqlExcepcion)
        {
            ...
            switch (pSqlExcepcion.Number)
            {
                ...
                case 208: //Invalid object name '%ls'."
                    ...
                    break;
                case 547:
                    msg = "Error de Integridad, intentó borrar o salvar un registro que tiene u n dato Padre referenciado";
                    break;
                case 2627: //Login failed for user '%ls'. Reason: Not associated with a trusted SQL Server connection.msg = "Error el código que está intentando salvar YA EXISTE";
                    break;
                case 2812:
